...
const { GameCreatedEvent, GameCreatedData } = require('../../src/models/events/game-created-event');
const { DiceRolledEvent, DiceRolledData } = require('../../src/models/events/dice-rolled-event');
...
describe('BasicGameStrategy', function() {
    ...
    describe('Two Players with normal win', function() {
        it('Should throw exception if player in wrong order', function() {
            ...
            const gcMetadata = new GameCreatedData('basic', ["e0ba4a44-3dc6-4564-8b44-6ab1403ac41a", "e0ba4a44-3dc6-4564-8b44-6ab1403ac41b"], 10);
        ...
        it('Should throw exception if player in wrong order in first round second turn', function() {
            ...
            const gcMetadata = new GameCreatedData('basic', ["e0ba4a44-3dc6-4564-8b44-6ab1403ac41a", "e0ba4a44-3dc6-4564-8b44-6ab1403ac41b"], 10);
            const gcEvent = new GameCreatedEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), gcMetadata);
            const dc1Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 2]);
        ...
        it('Should create DiceRolledEvent in second round third turn', function() {
            ...
            const dc2Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 2]);
        ...
        it('Should create DiceRolledEvent in second round forth turn ', function() {
            ...
            const dc3Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 2]);
        ...
        it('Should create DiceRolledEvent in third round fifth turn ', function() {
            ...
            const dc1Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
            const dc1Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc1Metadata);

            const dc2Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
            const dc2Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc2Metadata);

            const dc3Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
            const dc3Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc3Metadata);

            const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [2, 2, 2]);
        ...
        it('Should create DiceRolledEvent and GameCompletedEvent in third round sixth turn ', function() {
            ...
            const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
            const dc4Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc4Metadata);

            const dc5Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
    ...
    describe('Two Players with same points wait last round', function() {
        it('Should send DiceRolledEvent even if last round', function() {
            ...
            const dc1Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
            const dc1Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc1Metadata);

            const dc2Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
            const dc2Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc2Metadata);

            const dc3Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
            const dc3Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc3Metadata);

            const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
            const dc4Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc4Metadata);

            const dc5Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
            const dc5Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc5Metadata);
        ...
        it('Should create DiceRolledEvent and GameCompletedEvent in forth round eighth turn', function() {
            ...
            const dc6Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
            const dc6Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc6Metadata);

            const dc7Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
    ...
    describe('Three Players with elimination on third round', function() {
        describe('Eliminate first player', function() {
            it('Should create DiceRolledEvent and PlayerLostEvent', function() {
                const context = new Game();
                const gcMetadata = new GameCreatedData('basic', [
                ...
                const dc2Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [2, 2, 2]);
                const dc2Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc2Metadata);

                const dc3Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41c', [2, 2, 2]);
                const dc3Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc3Metadata);

                const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
                const dc4Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc4Metadata);

                const dc5Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [2, 2, 2]);
                const dc5Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc5Metadata);

                const dc6Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41c', [2, 2, 2]);
                const dc6Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc6Metadata);

                const dc7Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [1, 1, 1]);
                const dc7Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc7Metadata);

                const dc8Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [2, 2, 2]);
            ...
            it('Should create DiceRolledEvent and GameCompletedEvent after elimiation', function() {
                ...
                const dc9Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41c', [2, 2, 2]);
                const dc9Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc9Metadata);
                // 4 round
                const dc10Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [2, 2, 2]);
        ...
        describe('Eliminate second player', function() {
            it('Should create DiceRolledEvent and PlayerLostEvent', function() {
                ...
                const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
                const dc4Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc4Metadata);

                const dc5Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
                const dc5Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc5Metadata);

                const dc6Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41c', [2, 2, 2]);
                const dc6Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc6Metadata);

                const dc7Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
                const dc7Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc7Metadata);

                const dc8Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41b', [1, 1, 1]);
                const dc8Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc8Metadata);
            ...
            it('Should create DiceRolledEvent and GameCompletedEvent after elimiation', function() {
                ...
                const dc9Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc9Metadata);
                // 4 round
                const dc10Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [2, 2, 2]);
                const dc10Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc10Metadata);
        ...
        describe('Eliminate second and third player', function() {
            it('Should create DiceRolledEvent and PlayerLostEvent and GameCompletedEvent', function() {
                ...
                const dc1Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [3, 3, 3]);
                const dc1Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc1Metadata);
                ...
                const dc4Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [3, 3, 3]);
                const dc4Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc4Metadata);
                ...
                const dc7Metadata = new DiceRolledData('e0ba4a44-3dc6-4564-8b44-6ab1403ac41a', [3, 3, 3]);
                const dc7Event = new DiceRolledEvent("e0ba4a44-3dc6-4564-8b44-6ab1403ac41c", new Date('2019-01-01'), dc7Metadata);
